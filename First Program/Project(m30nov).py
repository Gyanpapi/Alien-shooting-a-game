...
bomb_speed=0
def collision():
    global j,catcher_x,bomb_x,ran,bomb_speed,score
    if(-300<=j<=-250 and ((bomb_x-24<=catcher_x+50) and bomb_x+24>=catcher_x-50)):
...
def draw():
    global bg_color,game_paused,m,catcher_x,bomb_x,bomb_y,j,explode_flag_for_moon,parachute_y,moon_j,moon_flag,m,k # space ship x axis variable m and y for k
